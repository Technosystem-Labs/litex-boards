...
_io_v2_0 = [
    ...
    ("ddmtd_main_dcxo_i2c", 0,
        Subsignal("scl", Pins("U7")),
        Subsignal("sda", Pins("N14")),
        IOStandard("LVCMOS25")),
...
class Platform(Xilinx7SeriesPlatform):
    ...
    def __init__(self, hw_rev="v1.0", toolchain="vivado"):
        if hw_rev == "v1.0":
            io_rev = _io_v1_0
        ...
        if hw_rev != "v1.0":
            # NOTE: on Kasli/v1.0 boards the XADC reference was incorrect
            self.toolchain.bitstream_commands.extend([
    ...
    def create_programmer(self):
        return OpenOCD("openocd_xc7_ft4232.cfg", "bscan_spi_xc7a100t.bit")